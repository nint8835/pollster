import { PollsterContext } from './pollsterContext';

const baseUrl = ''; // TODO add your baseUrl

export type ErrorWrapper<TError> = TError | { status: 'unknown'; payload: string };

export type PollsterFetcherOptions<TBody, THeaders, TQueryParams, TPathParams> = {
    url: string;
    method: string;
    body?: TBody;
    headers?: THeaders;
...
export async function pollsterFetch<
    TData,
    TError,
...
>({
    ...
    queryParams,
    signal,
}: PollsterFetcherOptions<TBody, THeaders, TQueryParams, TPathParams>): Promise<TData> {
    try {
